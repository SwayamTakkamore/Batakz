  ...
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    ...
    <div className="text-center lg:w-2/3 w-full">
      ...
      <div className="flex justify-center items-center flex-col">
        <button className=" text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg my-2"><Link href="/test">Know your mental health</Link></button>
        <button className="ml-4  text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg"><Link href="/resources">Resources</Link></button>
      </div>
    </div>
  </div>
</section>
